...
def fetch_notion_content(url):
    try:
        ...
        return f"Error fetching Notion content: {e}"
...
if (send or (q and not any(msg["q"] == q for msg in st.session_state.history))):
    if q:
